	...
	<!-- header 시작 -->
	 <div class="nav-container">
        ...
        <c:choose>
			...
			<c:when test="${user_onDTO != null && isAdminLogOn != null && isAdminLogOn == true && user_onDTO.u_auth == 'B' }">
                <b class="aTag">관리자 <span>${user_onDTO.u_email }</span>님</b>
                <div class="nav-item"><a href="${path }/member/logout.do" class="aTag">로그아웃</a></div>
                <div class="nav-item"><a href="${path }/member/adminMain.do" class="aTag">어드민페이지</a></div>
		...
		<div class="container-fluid">
			<div class="collapse navbar-collapse menu-bar" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="./reservList.html">내 예약</a></li>
					<li class="nav-item"><a class="nav-link" href="${path }/resto/restoList.do">식당</a></li>
					<li class="nav-item"><a class="nav-link" href="${path }/community/community.do">커뮤니티</a>
					</li>
				</ul>
			</div>
		</div>
