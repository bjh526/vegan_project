...
<body>
   <!-- login 시작 -->
        ...
        <main class="form-signin">
            <form method="post" name="frmLogin" action="${path }/member/login.do">
            	...
            	<div class="section-logo">
	                <a href="${path }/main"><img class="mb-4" src="<c:url value='/resources/img/vegetable_logos_finals/tight_light_mask.png' />" 
	                        alt="" height="57"></a>
                </div>
                <!-- 로고 끝 -->
                ...
                <button class="w-100 btn btn-lg btn-primary loginBtn" type="submit"
                    ...
                    <div class="setion_btns">
	                    <span class="mb-3 text-muted" id="btn_searchEmail"><button type="button" class="btn_txt">이메일찾기</button></span>&nbsp;
						<span class="mb-3 text-muted" id="btn_searchPwd"><button type="button" class="btn_txt">비밀번호찾기</button></span>&nbsp;
						<span class="mb-3 text-muted"><a href="join.html" class="aTag">회원가입</a></span>
                    </div>
        ...
        <div class="inner_search">
            <div class="form-signin">
                ...
                <!-- 로고 끝 -->
                    ...
                    <button class="w-100 btn btn-lg btn-primary loginBtn" type="submit"
                        style="background-color:#55771C; border:none">이메일 찾기</button>
    ...
    <!-- 비밀번호 찾기 끝 -->
    <script src="<c:url value='/resources/script/loginForm.js' />"></script>  
</body>
